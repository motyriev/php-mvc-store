...
class User
{
	 ...
	 */
	public static function register($firstName,$lastName, $email, $phone, $password, $city, $postal)
	{
		...
		$sql = "
                INSERT INTO users(first_name, last_name, email, phone, password, city, postal)
                VALUES(:first_name, :last_name, :email, :phone, :password, :city, :postal)
	 ...
	 * @return bool
	 */
	public static function checkPostal($postal)
	{
		if (strlen($postal) > 0)
			return true;
		return false;
